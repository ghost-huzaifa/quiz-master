    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-center lg:text-left space-y-6">
          <div className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
          ...
          <p className="text-lg text-gray-600 max-w-md">
            A modern platform for educators to create engaging quizzes and students to test their knowledge with real-time feedback.
          </p>
